...
class DaftarApotekPage extends React.Component<Props, State> {
		...
		return (
			<Container style={styles.container}>
				<Header>
					...
					<Body style={{ flex: 3 }}>
						<Title>List Pengambilan Obat</Title>
					</Body>
					...
					{ !!this.props.lists &&
						<List>
							{Object.keys(this.props.lists).map(key =>
								<ListItem
									key={key}
									onPress={() => this.props.navigation.navigate("DetailApotekPasienPage", {name: {key}} )}
									>
...
export default DaftarApotekPage;
